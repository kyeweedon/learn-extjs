...
folder are mapped to the application's root namespace, 'LearnExtJS'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "LearnExtJS"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'LearnExtJS' in the same way
as `"LearnExtJS/sass/src"`.
